...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "0.7.2"
  WORKING_DIRECTORY "C:/MainDic/TinyRenderer/build/_deps/utemplate-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("0.7.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/0.7.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/MainDic/TinyRenderer/build/_deps/utemplate-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/MainDic/TinyRenderer/build/_deps/utemplate-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
